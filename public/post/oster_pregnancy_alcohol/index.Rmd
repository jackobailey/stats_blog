...
[^korea]: If you want to add on a small tail of positive outcomes to the prior that's fine too (perhaps the asteroid hits Vladmir Putin and ends the invasion of Ukraine), but for the levels of evidence we're talking about it's not going to matter. 
...
This fact is not widely recognised[^exceptions] and it affects pretty much all selection-on-observables studies:
