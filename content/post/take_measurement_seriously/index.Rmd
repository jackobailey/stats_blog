...
ev.basic.both.err2 <- eivreg(data = data.frame(y, x1 = x1obs, x2 = x2obs), 
                             formula = y~x1 + x2, 
                             Sigma_error =  sigmas)
kable(round(summarizeEIV(ev.basic.both.err2 ), 3))
```
