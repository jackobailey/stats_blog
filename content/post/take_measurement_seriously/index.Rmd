...
However, if you just plug the IRT estimates into a regression it doesn't look took good: both the coefficients are attenuated.[^irtattenuate] $x_1$'s coefficient should be 1 and $x_2$'s coefficient should be -1. Clearly, we need to account for the measurement error. 
