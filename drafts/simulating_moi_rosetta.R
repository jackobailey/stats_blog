...
moiIRTForSurvey <- function(current.survey, reliabilities) {
  reliability <- reliabilities[current.survey]
  data.temp <- data2[data2$survey==current.survey, ]  
...
all.eirt.for.rxx <- function(reliabilities, FUN = eivIRTForSurvey) {
...
# eirtn2.comb.true.rxx <- all.eirt.for.rxx(reliabilities = true.reliabilities, 
#                                         FUN = eivIRTForSurveyNaive2)
# eirtn2.comb.emp.rxx <-  all.eirt.for.rxx(reliabilities = empirical.reliabilities, 
#                                         FUN = eivIRTForSurveyNaive2)
# eirtn2.comb.marg.rxx <-  all.eirt.for.rxx(reliabilities = marginal.reliabilities, 
#                                          FUN = eivIRTForSurveyNaive2)
# eirtn2.comb.true.rxx$reliability.method <- 'true'
# eirtn2.comb.emp.rxx$reliability.method <- 'empirical'
# eirtn2.comb.marg.rxx$reliability.method <- 'marginal'
...
eirt.comb<- rbind(eirt.comb.true.rxx, eirt.comb.emp.rxx, eirt.comb.marg.rxx,
                  eirtn.comb.true.rxx, eirtn.comb.emp.rxx, eirtn.comb.marg.rxx, 
                  moirt.comb.true.rxx, moirt.comb.emp.rxx, moirt.comb.marg.rxx,
                  moirtn.comb.true.rxx, moirtn.comb.emp.rxx, moirtn.comb.marg.rxx)
